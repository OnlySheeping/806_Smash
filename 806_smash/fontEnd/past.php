            ...
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="current"><a href="past.php">Results</a></li>
    ...
    <section class="s-content">
        ...
        <div class="row narrow">
            <div class="col-full s-content__header" data-aos="fade-up">
                ...
                <p class="lead">View recent tournament results for local Smash Bros Ultimate tournaments!</p>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-full">
                    <div class="s-footer__copyright">
                        <span>© Copyright Julian Jacquz 2019</span> 
